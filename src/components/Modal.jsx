            ...
            >
              ...
              >
                <div className="relative z-10">
                  ...
                  <form className="mt-5 space-y-8" onSubmit={onSubmitAddPaciente}>
                    <div className="relative z-0">
                      <Inputs label={"Nome:"} />
                    </div>
                    <div className="relative z-0">
                    ...
                    <button type="submit" className="bg-[#00bfa6] rounded-lg hover:opacity-90 transition-opacity text-white font-semibold w-full py-2">
                      Adicionar
                    </button>
                  </form>
                </div>
