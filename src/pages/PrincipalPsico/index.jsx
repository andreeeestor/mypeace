    ...
    <>
      ...
      <main className="max-w-[1440px] mx-auto 2xl:p-0 py-3 px-6">
        ...
        {/* <section className="flex items-center justify-center md:gap-0 gap-5 md:justify-between flex-wrap">
          ...
          <Link
            to="/principalPsico/listapaciente"
            className="cursor-pointer w-36 h-44 bg-gray-200 rounded-md p-5 shadow-3D hover:border-b-4 hover:border-gray-500 transition-all flex flex-col justify-around"
          >
            <UserList size={40} />
